...
const Home = () => {
  ...
  const searchDataRef = React.useRef<SearchInfo | null>(null);
      ...
      try {
        ...
        setMessages(prev => [
          ...prev,
          {
            ...
            isLoading: true,
            searchInfo: {
              stages: [] as Array<'searching' | 'reading' | 'writing' | 'error'>,
              query: "",
              urls: []
            }
          }
          ...
          try {
            ...
            if (data.type === 'checkpoint') {
              ...
              const newSearchInfo: SearchInfo = {
                stages: ['searching'] as Array<'searching' | 'reading' | 'writing' | 'error'>,
                query: data.query,
                urls: []
              };
              ...
              try {
                ...
                const newSearchInfo: SearchInfo = {
                  stages: searchData ? [...searchData.stages, 'reading'] as Array<'searching' | 'reading' | 'writing' | 'error'> : ['reading'] as Array<'searching' | 'reading' | 'writing' | 'error'>,
              ...
              // Handle search error
              const newSearchInfo: SearchInfo = {
                stages: searchData ? [...searchData.stages, 'error'] as Array<'searching' | 'reading' | 'writing' | 'error'> : ['error'] as Array<'searching' | 'reading' | 'writing' | 'error'>,
                query: searchData?.query || "",
                error: data.error,
                urls: []
              };
              ...
              if (searchData) {
                const finalSearchInfo: SearchInfo = {
                  ...searchData,
                  stages: [...searchData.stages, 'writing'] as Array<'searching' | 'reading' | 'writing' | 'error'>
                };
